...
def ControlMaker(name, form, colorNum, exGrp=False, size=1.0):
    ...
    if form == 'circle':
        ...
        cvLs = [([-2.8502384452622207e-15, -14.482233784631779, -14.482233784631799]),
                 ([-5.115907697472721e-15, 2.381756713921338e-28, -13.653980954456065]),
                 ([-5.871130781542888e-15, 14.482233784631791, -14.482233784631784]),
                 ([-5.115907697472721e-15, 13.653980954456074, -3.020892336280668e-15]),
                 ([-4.360684613402555e-15, 14.482233784631788, 14.482233784631788]),
                 ([-6.626353865613054e-15, 3.0208923362809047e-15, 13.65398095445608]),
                 ([-4.360684613402555e-15, -14.482233784631784, 14.482233784631777]),
                 ([-5.115907697472721e-15, -13.65398095445607, -1.510446168140334e-15]),
                 ([-2.8502384452622207e-15, -14.482233784631779, -14.482233784631799]),
                 ([-5.115907697472721e-15, 2.381756713921338e-28, -13.653980954456065]),
                 ([-5.871130781542888e-15, 14.482233784631791, -14.482233784631784])]
        ...
        list(map(lambda i: rst[0].cp[i].set(cvLs[i][0], cvLs[i][1], cvLs[i][2]), [x for x in range(8)]))
         ...
         rst[0] = pm.curve(d=3, n=name, p=[([0.3050239039446908, 5.234502313812128e-28, -12.200955975979204]),
                                         ([0.3050239039446908, 6.913875053054882, -12.200955975979204]),
                                         ([0.3050239039446908, 8.976270453071601, -11.852063355596082]),
                                         ([0.3050239039446908, 10.414166904333843, -10.414166904333843]),
                                         ([0.3050239039446908, 11.852063355596082, -8.976270453071603]),
                                         ([0.3050239039446908, 12.200955975979204, -6.913875053054882]),
                                         ([0.3050239039446908, 12.200955975979204, 3.605937403704791e-16]),
                                         ([0.10167463464822761, 12.200955975979204, 3.605937403704791e-16]),
                                         ([-0.30502390394469, 12.200955975979204, 3.605937403704791e-16]),
                                         ([-0.30502390394469, 12.200955975979204, 3.605937403704791e-16]),
                                         ([-0.30502390394469, 12.200955975979204, 3.605937403704791e-16]),
                                         ([0.10167463464822761, 12.200955975979204, 3.605937403704791e-16]),
                                         ([0.3050239039446908, 12.200955975979204, 3.605937403704791e-16]),
                                         ([0.3050239039446908, 12.200955975979204, 6.913875053054882]),
                                         ([0.3050239039446908, 11.852063355596082, 8.976270453071601]),
                                         ([0.3050239039446908, 10.414166904333843, 10.414166904333843]),
                                         ([0.3050239039446908, 8.976270453071601, 11.852063355596078]),
                                         ([0.3050239039446908, 6.913875053054882, 12.200955975979204]),
                                         ([0.3050239039446908, 5.234502313812128e-28, 12.200955975979204]),
                                         ([0.10167463464822761, 5.234502313812128e-28, 12.200955975979204]),
                                         ([-0.30502390394469, 5.234502313812128e-28, 12.200955975979204]),
                                         ([-0.30502390394469, 5.234502313812128e-28, 12.200955975979204]),
                                         ([-0.30502390394469, 5.234502313812128e-28, 12.200955975979204]),
                                         ([0.10167463464822761, 5.234502313812128e-28, 12.200955975979204]),
                                         ([0.3050239039446908, 5.234502313812128e-28, 12.200955975979204]),
                                         ...
                                         ([0.3050239039446908, 5.234502313812128e-28, -12.200955975979204]),
                                         ([0.10167463464822761, 5.234502313812128e-28, -12.200955975979204]),
                                         ([-0.10167463464823119, 5.234502313812128e-28, -12.200955975979204]),
                                         ([-0.30502390394469, 5.234502313812128e-28, -12.200955975979204]),
                                         ([-0.30502390394469, 6.913875053054882, -12.200955975979204]),
                                         ([-0.30502390394469, 8.976270453071601, -11.852063355596082]),
                                         ([-0.30502390394469, 10.414166904333843, -10.414166904333843]),
                                         ([-0.10167463464823119, 10.414166904333843, -10.414166904333843]),
                                         ([0.3050239039446908, 10.414166904333843, -10.414166904333843]),
                                         ([0.3050239039446908, 10.414166904333843, -10.414166904333843]),
                                         ([0.3050239039446908, 10.414166904333843, -10.414166904333843]),
                                         ([-0.10167463464823119, 10.414166904333843, -10.414166904333843]),
                                         ([-0.30502390394469, 10.414166904333843, -10.414166904333843]),
                                         ([-0.30502390394469, 11.852063355596082, -8.976270453071603]),
                                         ([-0.30502390394469, 12.200955975979204, -6.913875053054882]),
                                         ([-0.30502390394469, 12.200955975979204, 3.605937403704791e-16]),
                                         ([-0.30502390394469, 12.200955975979204, 6.913875053054882]),
                                         ([-0.30502390394469, 11.852063355596082, 8.976270453071601]),
                                         ([-0.30502390394469, 10.414166904333843, 10.414166904333843]),
                                         ([-0.10167463464823119, 10.414166904333843, 10.414166904333843]),
                                         ([0.3050239039446908, 10.414166904333843, 10.414166904333843]),
                                         ([0.3050239039446908, 10.414166904333843, 10.414166904333843]),
                                         ...
                                         ([-0.10167463464823119, 10.414166904333843, 10.414166904333843]),
                                         ([-0.30502390394469, 10.414166904333843, 10.414166904333843]),
                                         ([-0.30502390394469, 8.976270453071601, 11.852063355596078]),
                                         ([-0.30502390394469, 6.913875053054882, 12.200955975979204]),
                                         ([-0.30502390394469, 5.234502313812128e-28, 12.200955975979204]),
                                         ([-0.30502390394469, -6.913875053054882, 12.200955975979204]),
                                         ([-0.30502390394469, -8.976270453071601, 11.852063355596078]),
